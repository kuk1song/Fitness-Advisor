    ...
    <>
      ...
      <form onSubmit={handleSubmit} style={{ textAlign: 'center', marginTop: '20px' }}>
        ...
        <div className="input-field-container">
          <input type="number" name="height" value={userData.height} onChange={handleChange} placeholder="Height (Meters)" style={{visibility: step===0?"visible":"collapse"}}  />
          <input type="number" name="weight" value={userData.weight} onChange={handleChange} placeholder="Weight (Lbs)" style={{visibility: step===1?"visible":"collapse"}}  />
